module git.zjuqsc.com/miniprogram/wechat-backend
...
replace (
	cloud.google.com/go => github.com/GoogleCloudPlatform/google-cloud-go v0.26.0
	golang.org/x/crypto => github.com/golang/crypto v0.0.0-20180904163835-0709b304e793
	golang.org/x/lint => gitlab.com/laphets/lint v0.0.0-20180702182130-06c8688daad7
